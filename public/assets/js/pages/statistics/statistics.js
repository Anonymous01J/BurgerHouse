...
const {statistics} = introTooltip()
statistics('navbarDropdown')
const { instance, graphic1, graphic2, graphic3, graphic4, graphic5, graphic6 } = graphicInstance()
...
document.querySelectorAll(".form_select_type_filter").forEach((select) => {
    select.addEventListener("change", (e) => {
        if (e.target.value == "Semana/mes/año") {
            ...
            else if (select.getAttribute("graphic") == "Porcentaje de reservaciones") graphic3(undefined, undefined, undefined, "ReservaHorarioSemana", () => printPDF())
            else if (select.getAttribute("graphic") == "reservaciones por metodo") graphic4(undefined, undefined, undefined, "ReservasPorMetodoSemana", () => printPDF())
            ...
            else if (select.getAttribute("graphic") == "Porcentaje de reservaciones") graphic3(undefined, undefined, undefined, "ReservaHorarioMes", () => printPDF())
            else if (select.getAttribute("graphic") == "reservaciones por metodo") graphic4(undefined, undefined, undefined, "ReservasPorMetodoMes", () => printPDF())
            ...
            else if (select.getAttribute("graphic") == "Porcentaje de reservaciones") graphic3(undefined, undefined, undefined, "ReservaHorarioAnio", () => printPDF())
            else if (select.getAttribute("graphic") == "reservaciones por metodo") graphic4(undefined, undefined, undefined, "ReservasPorMetodoAnio", () => printPDF())
...
document.querySelectorAll(".container_inputs_filter").forEach(form => {
    form.addEventListener("submit", (e) => {
        ...
        if (selectOption == "Semana/mes/año") {
            ...
            else if (type == "Porcentaje de reservaciones") graphic3(anio, semana, null, "ReservaHorarioSemana", () => printPDF())
            else if (type == "reservaciones por metodo") graphic4(anio, semana, null, "ReservasPorMetodoSemana", () => printPDF())
            ...
            else if (type == "Porcentaje de reservaciones") graphic3(anio, null, mes, "ReservaHorarioMes", () => printPDF())
            else if (type == "reservaciones por metodo") graphic4(anio, null, mes, "ReservasPorMetodoMes", () => printPDF())
            ...
            else if (type == "productos menos vendidos") graphic3(anio, null, null, "ReservaHorarioAnio", () => printPDF())
            else if (type == "reservaciones por metodo") graphic4(anio, null, null, "ReservasPorMetodoAnio", () => printPDF())

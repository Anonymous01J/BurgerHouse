<?php
    ...
    class Cliente extends DB {
        ...
        function __construct($id=null, $nombre=null,$cedula=null,$telefono=null,$like_nombre='',$like_cedula=''){
            $this->id = $id;
            $this->nombre = $nombre;
            $this->cedula = $cedula;
        ...
        function actualizar($usuario){
            $query = $this->conn->prepare("UPDATE clientes SET nombre=:nombre, cedula=:cedula,telefono=:telefono WHERE id=:id");

        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Marcas</h3>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                <li class="breadcrumb-item"><a href="./index.php">Modulos</a>
                                <li class="breadcrumb-item text-muted" aria-current="page">Marca</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Nombre de marca" aria-label="Recipient's username" aria-describedby="button-addon2">
                            ...
                            <div class="table-responsive mt-5">
                                <table class="table table-dark-mode no-wrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td><span class="fs-6">Craft</span></td>
                                            <td>

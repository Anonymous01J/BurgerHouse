<div class="modal fade" id="product_and_table" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0 overflow-x-hidden">
                <div id="stepper-2" class="bs-stepper">
                    ...
                    <div class="bs-stepper-content">
                        <div id="step-1" class="content" role="tabpanel" aria-labelledby="steppertrigger1">
                            ...
                            <div class="row">
                                <div class="row mb-5">
                                    <div class="d-flex gap-2 justify-content-start flex-wrap ps-0 cont_category_product_orders_local">
                                        <div>
                                ...
                                <div class="row cont-select-product-order_local">
                                    <!-- Productos -->
                                </div>
                            </div>
                            <div class="d-flex justify-content-end position-sticky start-100 bottom-0">
                                <button class="btn bh_1 mt-3 text-white select_product_btn_next_local">Siguiente</button>
                            </div>
                        </div>
                        <div id="step-2" class="content" role="tabpanel" aria-labelledby="steppertrigger2">
                            ...
                            <h4>COMIDA</h4>
                            <hr>
                            <div class="row cont-details-product-order-food_local">

                            </div>
                            <h4>OTROS</h4>
                            <hr>
                            <div class="row cont-details-product-order-other_local">
                                <!-- Otros -->
                            </div>
                            <hr>
                            <div class="row">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="subtotal_local">SUBTOTAL: 10 $</h4>
                                        <h4 class="iva_local">IVA: 025 $</h4>
                                        <hr>
                                        <h4 class="total-amount_local">TOTAL BS: 10 -- USD: 10</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end position-sticky start-100 bottom-0">
                                <button class="btn bh_5 text-white mt-3 me-2" onclick="stepper2.previous()">Anterior</button>
                                <button class="btn bh_1 text-white mt-3" onclick="stepper2.next()">Siguiente</button>
                            </div>
                        </div>
                        <div id="step-3" class="content" role="tabpanel" aria-labelledby="steppertrigger3">
                            <h5 class="text-center fs-3 mt-2 mb-4">ASIGNAR MESA</h5>
                            <hr class="mb-1">
                            ...
                            <div class="d-flex justify-content-end position-sticky start-100 bottom-0">
                                <button class="btn bh_5 text-white mt-3 me-2" onclick="stepper2.previous()">Anterior</button>
                                <button class="btn bh_1 text-white mt-3 btn_tables_order_local">Crear Orden</button>
                            </div>
                        </div>
                        <div id="step-5" class="content" role="tabpanel" aria-labelledby="steppertrigger5">
                            ...
                            <div class="row mb-4">
                                <div class="d-flex justify-content-start gap-3">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <p class="m-0 table_confirm_order_local">1</p>
                                    </div>
                                </div>
                            </div>
                            <h4>PRODUCTOS</h4>
                            ...
                            <div class="table-responsive mb-5">
                                <table class="table table-dark-mode">
                                    ...
                                    <tbody class="cont_confirm_product_order_local">

                                    </tbody>
                                </table>
                            </div>
                            <div class="d-flex justify-content-end position-sticky start-100 bottom-0">
                                <button class="btn btn-secondary mt-3 me-2" onclick="stepper2.previous()">Anterior</button>
                                <button class="btn btn-success mt-3 confirm_order_local">Enviar</button>
                            </div>
                        </div>
                    </div>
                </div>

                                                    ...
                                                    <div class="row g-2 payments-local" id="payments-local-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" maxlength="50" class="form-control w-75" placeholder="0.00" input_price id="input-quantity-orderLocal-1" name="cantidad">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" maxlength="50" class="form-control" placeholder="Referencia" id="input-reference-orderLocal-1" name="referencia">

            ...
            <div class="modal-body">
                <form class="row g-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Apellido" id="inputEmail4">
                    </div>
                    <div class="col-md-6 ">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Nro de documento" id="inputEmail4">
                    </div>
                    <div class="col-md-6">
                        <label for="inputEmail4" class="form-label">Correo Electronico</label>
                        <input type="text" class="form-control" placeholder="Correo Electronico" id="inputEmail4">
                    </div>
                    <div class="col-md-6 ">

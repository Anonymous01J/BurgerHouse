                                                    ...
                                                    <div class="row g-2 payments-reservation" id="payments-reservation-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control w-75" placeholder="0.00" input_price id="input-quantity-reservation-1" name="cantidad">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Referencia" id="input-reference-reservation-1" name="referencia">
                                                ...
                                                <div id="payments-container-reservation_edit">
                                                    <div class="row g-2 payments-reservation_edit" id="payments-reservation-edit-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-text type_payment">N/S</span>
                                                                <input type="text" class="form-control w-75" placeholder="0.00" input_price id="input-quantity-reservationEdit-1" name="cantidad">
                                                                <div class="text-danger mt-1 fs-6" id="error-input-quantity-reservationEdit-1"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label for="inputEmail4" class="form-label">Referencia</label>
                                                            <input type="text" class="form-control" placeholder="Referencia" id="input-reference-reservationEdit-1" name="referencia">

<!-- modal para agg clientes -->
<div class="modal fade" id="register-client" tabindex="-1">
...
<div class="modal fade" id="edit-client" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-2" id="form-submit-edit-client">
                    <div id="client-container">
                        <div class="row g-2 client" id="client">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <div class="dropdown select_options_td">
                                    <div class="dropdown">
                                        <div class="btn-group w-100" bis_skin_checked="1">
                                            <input type="button" class="btn btn-light w-75 text-start fs-6" value="Seleccione una opcion" id="input-td-client" name="tipo_documento">
                                            <button type="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span> <i data-feather="chevron-down"></i></span>
                                            </button>
                                            <div class="dropdown-menu p-2" bis_skin_checked="1">
            ...
            <div class="modal-footer">
                <button type="button" class="btn bh_5 text-white" data-bs-dismiss="modal">Cancelar</button>
                <label for="submit-edit-client" class="btn bh_1 text-white">Guardar</button>
            </div>
        </div>
    </div>
</div>

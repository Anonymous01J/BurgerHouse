        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex gap-4 align-items-center">
                    ...
                    <button type="button" class="btn bh_1 btn-circle text-white btn-add-tooltip" data-module-add="" data-bs-toggle="modal" data-bs-target="#register-rawMaterial" data-bs-title="Agregar unidad" data-bs-placement="top">
